...
class MainForm(Form):
	...
	def TimerballTick(self, sender, e):
		...
		if rscore == 5 and lscore == 0:
			rpdl.BackColor = Color.Peru
		   	
		if rscore == 10 and lscore == 0:
			rpdl.BackColor = Color.Silver
		   	
		if rscore == 15 and lscore == 0:
			rpdl.BackColor = Color.Goldenrod
		
		if lscore == 5 and rscore == 0:
			lpdl.BackColor = Color.Peru
		   	
		if lscore == 10 and rscore == 0:
			lpdl.BackColor = Color.Silver
		   	
		if lscore == 15 and rscore == 0:
			lpdl.BackColor = Color.Goldenrod
		
		if lscore == 50:  # Left win condition
		...
		if rscore == 50:  # Right win condition
			self._timerball.Enabled = False
			ball.Left = self.Width // 2
			ball.Top = self.Height // 2
			self.ballup = 0
